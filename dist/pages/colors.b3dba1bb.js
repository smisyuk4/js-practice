...
})({"3jZSQ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ebd88cd3b3dba1bb";
...
},{}],"aGbkW":[function(require,module,exports) {
...
const onClickCheckCard = (event)=>{
    ...
    if (!event.target.classList.contains("check")) event.target.classList.toggle("check");
    if (lastActiveBtn) {
...
},{}]},["3jZSQ","aGbkW"], "aGbkW", "parcelRequire716c")

//# sourceMappingURL=colors.b3dba1bb.js.map
