...
})({"7NpzG":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b6f0cbdbd0ccc94e";
...
},{}],"kQ2Cc":[function(require,module,exports) {
const refs = {
...
const onClickButton = (event)=>{
    ...
    // option #1
    if (currentActiveBtn !== null) currentActiveBtn.classList.remove("check");
...
const onClickButton2 = (event)=>{
    ...
    if (isActive) selectedBtns.delete(value);
    if (!isActive) selectedBtns.add(value);
...
},{}]},["7NpzG","kQ2Cc"], "kQ2Cc", "parcelRequire716c")

//# sourceMappingURL=Buttons_filter.d0ccc94e.js.map
