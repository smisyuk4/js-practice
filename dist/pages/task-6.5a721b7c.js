...
const onClickButtonAdd = ()=>{
    if (refs.inputName.value === "" || refs.inputPopulation.value === "" || refs.inputPersent.value === "") return;
    const markup = `<tr>
...
const onClickButtonRemove = ()=>{
    ...
    try {
        ...
        if (strFromLocalStorage !== null) {
            ...
            } else localStorage.removeItem("tableData");
        }
    } catch (error) {
        console.log(error.message);
    }
...
//# sourceMappingURL=task-6.5a721b7c.js.map
