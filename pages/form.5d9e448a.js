...
function populateTextarea() {
    ...
    if (saveMessage?.hasOwnProperty("email")) refs.form.email.value = saveMessage.email;
    if (saveMessage?.hasOwnProperty("message")) refs.form.message.value = saveMessage.message;
}
...
},{}]},["5wnQi","l9hyy"], "l9hyy", "parcelRequire716c")
