...
})({"4WlWu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "d42f000ea538d949";
...
},{}],"44Dvg":[function(require,module,exports) {
"use strict";
const refs = {
...
const onPressEscBtn = (event)=>{
    if (event.code === "Escape") onClickBtnClose();
};
const onClickBackdrop = (event)=>{
    if (event.currentTarget === event.target) onClickBtnClose();
};
refs.btnOpen.addEventListener("click", onClickBtnOpen);
refs.btnClose.addEventListener("click", onClickBtnClose);
refs.backdrop.addEventListener("click", onClickBackdrop);

},{}]},["4WlWu","44Dvg"], "44Dvg", "parcelRequire716c")

//# sourceMappingURL=modal_window.a538d949.js.map
